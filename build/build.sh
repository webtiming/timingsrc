...
node r.js -o baseUrl=../v2.1 name=timingsrc out=../lib/timingsrc-require-min-v2.1.js # built and minified for requirejs usage
node r.js -o baseUrl=../v2.1 name=timingsrc optimize=none out=../lib/timingsrc-require-v2.1.js # built for requirejs usage
node r.js -o almond-build-v2.1.js optimize=none out=../lib/timingsrc-v2.1.js # built for regular script includes
node r.js -o almond-build-v2.1.js out=../lib/timingsrc-min-v2.1.js # built and minified for regular script includes