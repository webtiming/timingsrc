---
layout: default
title: Example Multi-device Timing Converter
...
This is a modification of [Timing Converter Example](exp_timingconverter.html), using [Shared Motion](shared_motion.html) as online timing provider. 
